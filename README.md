...
- Conteúdo em `/scripts`: inclui utilitários locais e manuais, além de scripts de validação; em particular, `/scripts/validation` faz parte da verificação do repositório.
